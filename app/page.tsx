      ...
      <section className="w-full px-2 border-t-0 border-x-0 border-b-gray-400 border pb-20">
        ...
        <div className="grid grid-cols-1 grid-rows-2 gap-4 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-3 lg:grid-rows-1">
          <div className="md:border-0 flex flex-col justify-center items-center dark:border-b-white border-b-black border border-opacity-50 p-14 border-x-0 border-t-0">
            <Experience />
            <div className="text-xl text-center font-bold m-3 dark:text-white">
              Experience
            </div>
            <p className="text-center font-thin dark:text-white">
              With over 20 years in the industry, our team brings extensive
              knowledge in building design, construction, and project
              management, ensuring top-notch quality in every project.
            </p>
          </div>
          <div className="md:border-0 dark:border-b-white flex flex-col justify-center items-center border-b-black border border-opacity-50 p-14 border-x-0 border-t-0">
            ...
            <p className="text-center font-thin dark:text-white">
              We offer a full range of services, including architectural design,
              and project management, providing a one stop solution for all your
              building needs.
            </p>
          </div>
          <div className="md:border-0 dark:border-b-white flex flex-col justify-center items-center border-b-black border border-opacity-50 p-14 border-x-0 border-t-0">
            ...
            <p className="text-center font-thin dark:text-white">
              Our commitment to quality is unwavering. We adhere to the highest
              industry standards and conduct thorough quality checks at every
              stage of the project to ensure exceptional results
            </p>
          </div>
          <div className="md:border-0 flex flex-col justify-center items-center dark:border-b-white border-b-black border border-opacity-50 p-14 border-x-0 border-t-0">
            <Heart />
            ...
            <p className="text-center font-thin dark:text-white">
              ...
              your needs and work collaboratively to bring your vision to life
          ...
          <div className="md:border-0 flex flex-col justify-center items-center dark:border-b-white border-b-black border border-opacity-50 p-14 border-x-0 border-t-0">
            ...
            <p className="text-center font-thin dark:text-white">
              Our creative team utilizes the latest technology and design trends
              to deliver innovative and functional spaces that stand out and
          ...
          <div className="flex flex-col justify-center items-center p-14">
            ...
            <p className="text-center font-thin dark:text-white">
              We value our relationships with clients and work hard to build
              trust through transparency, integrity, and reliable communication.
            </p>
          </div>
          <div className="md:col-span-2 lg:col-span-3 flex flex-col justify-center items-center p-14">
            ...
            <p className="text-center font-thin dark:text-white">
              We understand the importance of deadlines. Our efficient project
              management ensures that we complete projects on time and within
